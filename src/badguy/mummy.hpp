...
#ifndef HEADER_SUPERTUX_BADGUY_MUMMY_HPP
#define HEADER_SUPERTUX_BADGUY_MUMMY_HPP

#include "badguy/boss.hpp"

class Mummy final : public Boss
{
public:
  Mummy(const ReaderMapping& mapping);
  ...
  static std::string class_name() { return "mummy"; }
  virtual std::string get_class_name() const override { return class_name(); }
  static std::string display_name() { return _("Mummy"); }
  virtual std::string get_display_name() const override { return display_name(); }
  virtual GameObjectClasses get_class_types() const override { return Boss::get_class_types().add(typeid(Mummy)); }
...
private:
  Mummy(const Mummy&) = delete;
  Mummy& operator=(const Mummy&) = delete;
};
