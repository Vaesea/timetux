...
FlyingPipe::FlyingPipe(const ReaderMapping& reader) :
  BadGuy(reader, "images/creatures/flying_pipe/flying_pipe.sprite"),
  total_time_elapsed(),
  puff_timer()
{
...
bool
FlyingPipe::collision_squished(MovingObject& object)
{
...
void
FlyingPipe::collision_solid(const CollisionHit& hit)
{
...
void
FlyingPipe::active_update(float dt_sec)
{
